...
const Sidebar = () => {
  return (
    <div className="hidden md:block items-center">
      ...
      <div className=" space-y-10 group  transition-all duration-300 rounded-md">
      <div className="bg-[#e6f1f8] rounded-xl p-5 flex gap-2 items-center mx-2">
      <svg
          ...
          <span className="hidden group-hover:block text-gray-500 ml-2 font-semibold">
                Home
              </span>
            </div>
        ...
        <div className="rounded-md">
          <ul>
            <li className="bg-[#e6f1f8] rounded-xl p-5 flex gap-2 items-center mx-2 my-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <li className="p-5 bg-[#e6f1f8] rounded-xl flex gap-2 items-center mx-2 mb-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <li className="p-5 bg-[#e6f1f8] rounded-xl mb-1 flex gap-2 items-center mx-2">
